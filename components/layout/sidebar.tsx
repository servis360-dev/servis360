...
export function Sidebar() {
    ...
    const generateMenu = (sector: string, type: string) => {
        ...
        // Herkes için Destek ve Ayarlar en sonda
        items.push(
            { id: 'support', label: 'Destek & Yardım', icon: LifeBuoy, href: '/dashboard/support' }, // YENİ
            { id: 'settings', label: 'Ayarlar', icon: Settings, href: '/dashboard/settings' }
        );
    ...
    return (
        <aside className="w-64 bg-slate-900 text-white h-screen fixed left-0 top-0 overflow-y-auto border-r border-slate-800 flex flex-col z-50 transition-all duration-300">
